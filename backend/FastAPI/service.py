...
class ChurnInput(BaseModel):
    ...
    OnlineSecurity:Annotated[Literal["Yes","No","No internet"],Field(...,)]
    OnlineBackup:Annotated[Literal["Yes","No","No internet"],Field(...,)]
    DeviceProtection:Annotated[Literal["Yes","No","No internet"],Field(...,)]
    TechSupport:Annotated[Literal["Yes","No","No internet"],Field(...,)]
